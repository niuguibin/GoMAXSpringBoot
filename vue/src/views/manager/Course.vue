  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="type2" label="课程类型1" show-overflow-tooltip></el-table-column>
        <el-table-column prop="type3" label="课程类型2" show-overflow-tooltip></el-table-column>
        <el-table-column prop="times" label="授课开始时间" width="100" show-overflow-tooltip></el-table-column>
        <el-table-column prop="timef" label="授课结束时间" width="100"  show-overflow-tooltip></el-table-column>
        ...
        <el-table-column label="操作" width="180" align="center">
          <template v-slot="scope">
            ...
            <el-button plain type="warning" @click="choiceCourse(scope.row)" size="mini"   v-if="user.role === 'STUDENT'"  :disabled="scope.row.status === '未开课'">选课</el-button>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="type2" label="课程类型1">
          <el-select v-model="form.type2" placeholder="请选择类型" style="width: 100%"   :disabled="user.role !== 'ADMIN' ">
        ...
        <el-form-item prop="type3" label="课程类型2">
          <el-select v-model="form.type3" placeholder="请选择类型" style="width: 100%"   :disabled="user.role !== 'ADMIN' ">
        ...
        <el-form-item prop="times" label="授课开始时间">
          <el-date-picker format="yyyy-MM-dd" value-format="yyyy-MM-dd"
                          v-model="form.times" style="width: 100%">
          </el-date-picker>
        </el-form-item>

        <el-form-item prop="timef" label="授课结束时间">
          <el-date-picker format="yyyy-MM-dd" value-format="yyyy-MM-dd"
                          v-model="form.timef" style="width: 100%">
          </el-date-picker>
        </el-form-item>
        ...
        <el-form-item prop="price" label="价格">
          <el-input v-model="form.price" autocomplete="off"   :disabled="user.role !== 'ADMIN' "></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    choiceCourse(row){
      ...
      // let data = JSON.parse(JSON.stringify(row))//对row进行一下深拷贝，即在这个row的对象外面在包装一个对象,禁止使用   row = data.name这样会在刷新的时候，又不显示了
     let data = {
      ...
      this.$request.post('/choice/add',data).then(res => {//讲这行信息塞给到选课表中去
        if (res.code === '200'){
